...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@600&family=Roboto+Condensed&display=swap" rel="stylesheet">
	<script defer src="js/popup_script.js"></script>
	<script defer src="js/ajax_script.js"></script>
</head>
<body>
  <header class="header">
    ...
    <nav class="align_nav">
      ...
      <button class="button button_small open-popup">Записаться на курс</button>
    </nav>
  </header>
  <main>
    <section class="main">
      <div class="main__info-align">
        ...
        <button class="button button_long main__button open-popup">Записаться на курс</button>
      </div>
    ...
    <section class="feature">
	  ...
	  <section class="popup__bg" id="popup__bg">
		  <div class="popup" id="popup">
			  <img class="popup__close close-popup" src="images/close.png" alt="" id="close-popup">
			  <?php
